...
import logoImage from '../img/image-18.png';
function Footer() {
  return (
          ...
          <div className="styles-module_horizontal_1i3Jc">
            <div className="styles-module_container_3Ng4k styles-module_footerNavigation_2XusU">
              <div className="styles-module_flexContainer_2BcQU">
                <a href="https://mangaplus.thinkowl.jp/portal/mangaplus/knowledgebase/default" className="styles-module_item_19Jr0">Help</a>
                <a href="/announcement" className="styles-module_item_19Jr0">News and Events</a>
                <a href="/privacypolicy/eng/" className="styles-module_item_19Jr0">Privacy Policy</a>
                <a href="/terms_web/eng/" className="styles-module_item_19Jr0">Terms of Services</a>
                <a href="/rating/eng/" className="styles-module_item_19Jr0">Content Ratings</a>
                <a href="/copyright/eng/" className="styles-module_item_19Jr0">Copyrights</a>
              </div>
            </div>
            <div className="styles-module_container_aAOj- styles-module_sns_1MuOK">
              ...
              <a href="https://www.facebook.com/mangaplus.en/"><img src="https://mangaplus.shueisha.co.jp/img/flogo-HexRBG-Wht-58.e3d3a393.svg" alt="" width="40" className="styles-module_icon_2bT0W" /></a>
            </div>
          </div>
        ...
        <div className="styles-module_container_kWnuS styles-module_appInfo_1BHlS">
          ...
          <div className="styles-module_vertical_2WFUo">
            ...
            <div className="styles-module_horizontal_nhDKQ">
              <a href="https://itunes.apple.com/app/id1442476536"><img src="https://mangaplus.shueisha.co.jp/img/AppStoreIcon.2928664f.svg" alt="AppStoreIcon" width="120" height="40" className="styles-module_appStoreIcon_3joeo" /></a>
              <a href="https://play.google.com/store/apps/details?id=jp.co.shueisha.mangaplus"><img src="https://mangaplus.shueisha.co.jp/img/google-play-badge.2104fab3.png" alt="PlayStoreIcon" width="134" height="40" className="styles-module_playStoreIcon_2Wzvj" /></a>
            </div>
          </div>
        </div>
      </div>
